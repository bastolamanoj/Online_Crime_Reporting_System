...
<div class="container1">
    ...
    <div class="main-section1 ">
        ...
        if(isset($_POST['submit'])){
            ...
            $uemail = $_POST['email'];
              // email verificaion
              $s_q = "SELECT * FROM employees WHERE email='$uemail'";
              ...
              if(!$data){
                  ...
                  echo '
                  <meta http-equiv="refresh" content="0; URL=add_employee.php?msg=emailerr" />
                  ';
                  die();
              }
            $phone = $_POST['phone'];
            ...
            $uusername = $_POST['username'];
              ...
              $s_q = "SELECT * FROM employees WHERE username='$uusername'";
              $s_r = mysqli_query($conn, $s_q);
              $data= mysqli_fetch_assoc($s_r);
              if(!$data){
            ...
            if($name != "" && $email != "" && $phone != "" && $password !="" ){
                if($password == $cpassword){
                    ...
                    $select_query = "INSERT INTO employees(name, surname, email, phone,access, gender,username,photo, password) 
