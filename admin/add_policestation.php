        ...
        if(isset($_POST['submit'])){
            ...
            if($name != "" && $email != "" && $phone != "" && $height !="" && $weight !="" && $phone !="" ){
              ...
              if(move_uploaded_file($_FILES['photo']['tmp_name'], "uploads/".$finalfile)){
                 $sql = "INSERT INTO criminals(name, surname,height, weight, gender, email, phone, province, district, city, photo) VALUES('$name', '$surname', '$height','$weight', '$gender', '$email', '$phone','$province', '$district', '$city', '$photo')";
